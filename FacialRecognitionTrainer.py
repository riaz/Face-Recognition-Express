...
# This file shows you how to train Face Recognition
# Enter the names of the faces and the output file.
cam = Camera(0) # using the primary camera
names = ['Riaz'] # put names of people to recognize over here
outfile = "testResults.csv" #output file 
